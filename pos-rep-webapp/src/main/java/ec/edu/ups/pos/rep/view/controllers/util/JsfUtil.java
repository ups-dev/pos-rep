...
public final class JsfUtil {
	...
	public static void addErrorMessage(String msg) {
		...
		FacesContext.getCurrentInstance().validationFailed(); // Invalidate JSF page if we
	...
	public static void addMensajeBundle(FacesMessage.Severity severity, String summary, String detail) {
