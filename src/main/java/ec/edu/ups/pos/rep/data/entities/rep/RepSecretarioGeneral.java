...
public class RepSecretarioGeneral extends EntitySuperclass {
	...
	public boolean equals(Object object) {
		...
		if ((this.segCodigo == null && other.segCodigo != null)
				|| (this.segCodigo != null && !this.segCodigo.equals(other.segCodigo))) {
			return false;
		}
		return true;
	}
	...
	public int hashCode() {
		int hash = 0;
		hash += ((this.segCodigo != null) ? this.segCodigo.hashCode() : 0);
		return hash;
	}

	@Override
	public String toString() {
		return "RepSecretarioGeneral[ segCodigo=" + this.segCodigo + " ]";
	}
