...
public class PosRepPosgradosFacade extends AbstractFacade<PosgradoAlumnoWrapper> {
	...
	public List<PosgradoAlumnoWrapper> listaPosgrados(Long aluCodigo) {
		...
		Query q = getEntityManager().createNativeQuery("   select distinct aluCodigo,   "
				...
				+ "       sede, campus, " + "       posgrado,   " + "       estSede,   " + "       estCampus,   "
				+ "       estPosgrado,   " + "       preCodigo, proyecto,   " + "       modalidad,   "
				+ "       periodo,   " + "       codPeriodo,   " + "       cohorte,   " + "       cedula,   "
				+ "       estudiante,    " + "       tieneMencion,   "
				+ "       NVL(tieneMencionEst,'N') tieneMencionEst,   " + "       totalMenciones,  "
				...
				+ "       preCodigo,  " + "       codMencionEstudiante," + "       vigencia,  "
				+ "       NVL(actaGrado,'N') actaGrado " + "       from (" + "                select distinct "
				...
				+ "              from ins.ins_ins_pro_aca ipa," + "                   ped.ped_mod_pro_edu mpe,"
